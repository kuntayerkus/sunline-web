...
with veri(ad, kategori, marka, model, aciklama, adet) as (values
  ...
  ('Korg Kronos 3', 'Klavye', 'Korg', 'Kronos', 'Workstation synthesizer', 1),
  ...
  ('Ampeg SVT-R Pro', 'Gitar & Amfi', 'Ampeg', 'SVT-R Pro', 'Bas amfi kafası (model teyit)', 1),
  ...
  ('Mark Bass 1x15" MBR15 Kabin', 'Gitar & Amfi', 'Markbass', 'MBR15', '1x15 bas kabin (model teyit)', 1),
