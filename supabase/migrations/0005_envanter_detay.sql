...
with veri(ad, kategori, marka, model, aciklama, adet) as (values
  ...
  ('Ampeg SVT-R Pro', 'Gitar & Amfi', 'Ampeg', 'SVT-R Pro', 'Bas amfi kafası (model teyit — muhtemelen SVT-VR / SVT-CL)', 1),
  ...
  ('Mark Bass 1x15" MBR15 Kabin', 'Gitar & Amfi', 'Markbass', 'MBR15', '1x15 bas kabin (model teyit — muhtemelen Standard 151HR / New York 151)', 1),
